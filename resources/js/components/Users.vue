            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 v-show="editmode" class="modal-title" id="exampleModalLabel">Update Users Info</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input v-model="form.email" placeholder="Email" id="email" type="email" name="name"
                                   class="form-control" :class="{ 'is-invalid': form.errors.has('email') }">
                            <has-error :form="form" field="email"></has-error>
                        </div>
                        <div class="form-group">
                            <textarea v-model="form.bio" placeholder="Bio" id="bio" name="bio"
                        ...
                        <div class="form-group">
                            <input v-model="form.password" placeholder="password" id="password" type="password" name="password"
